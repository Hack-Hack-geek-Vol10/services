...
func (x *CreateUserParams) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *GetUserParams) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_user_service_v1_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0x55, 0x0a,
	0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x6d, 0x61, 0x69, 0x6c, 0x22, 0x28, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x50,
	...
	0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x17, 0x0a, 0x07,
	...
	,
...
var file_user_service_v1_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_user_service_v1_user_service_proto_goTypes = []interface{}{
	(*CreateUserParams)(nil), // 0: user.v1.CreateUserParams
	(*GetUserParams)(nil),    // 1: user.v1.GetUserParams
	(*UserDetail)(nil),       // 2: user.v1.UserDetail
}
var file_user_service_v1_user_service_proto_depIdxs = []int32{
	0, // 0: user.v1.UserService.CreateUser:input_type -> user.v1.CreateUserParams
	1, // 1: user.v1.UserService.GetUser:input_type -> user.v1.GetUserParams
	2, // 2: user.v1.UserService.CreateUser:output_type -> user.v1.UserDetail
	2, // 3: user.v1.UserService.GetUser:output_type -> user.v1.UserDetail
